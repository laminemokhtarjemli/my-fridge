...
class DetailsScreenVeg extends StatelessWidget {
  final ItemVeg itemVeg;

  const DetailsScreenVeg({Key? key, required this.itemVeg}) : super(key: key);
