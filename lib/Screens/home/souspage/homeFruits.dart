...
import 'package:myfridge/Items/item_card_fruit.dart';
...
class HomeFruit extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              StaggeredGridView.countBuilder(
                ...
                crossAxisCount: 1,
                itemCount: demoItemsFruit.length,
                crossAxisSpacing: 15,
                physics: NeverScrollableScrollPhysics(),
                shrinkWrap: true,
                mainAxisSpacing: 0,
                itemBuilder: (context, index) {
                  return ItemCardfruit(
                      itemFruit: demoItemsFruit[index], index: index);
                },
